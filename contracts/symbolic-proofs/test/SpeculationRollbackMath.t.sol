...
///   rollback math      → prsm/compute/chain_rpc/client.py:1585
///                        cached_extra = (k_round + 1) - len(emitted)
///   adaptive-K bounds  → prsm/compute/chain_rpc/client.py:1617-1620
...
contract SpeculationRollbackMath {
    ...
    /// Mirrors client.py:1585 — the POST-FIX correct formula.
    ...
    /// Mirrors client.py:1617-1620 — adaptive K state transition
