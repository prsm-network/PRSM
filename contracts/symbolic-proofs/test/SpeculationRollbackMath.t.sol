...
///   rollback math      → prsm/compute/chain_rpc/client.py:1591
///                        cached_extra = (k_round + 1) - len(emitted)
///   adaptive-K bounds  → prsm/compute/chain_rpc/client.py:1623-1626
...
contract SpeculationRollbackMath {
    ...
    /// Mirrors client.py:1591 — the POST-FIX correct formula.
    ...
    /// Mirrors client.py:1623-1626 — adaptive K state transition
